 <!-- Bootstrap 3.3.2 -->
    ...
    <!-- Font Awesome Icons -->
    <link href="{{ URL::asset('https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- Ionicons -->
    <link href="{{ URL::asset('http://code.ionicframework.com/ionicons/2.0.0/css/ionicons.min.css') }}" rel="stylesheet" type="text/css" />
    <!-- DATA TABLES -->
