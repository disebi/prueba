 ...
 <div class="row">
 <div class="col-lg-12">
    <p> En esta pagina podra editar un registro de {{$referencial}} de  {{$independiente}}</p>
 </div>
 </div>
 <ul class="control-sidebar-menu">
             <li>
                             <a>
                               ...
                               <div class="menu-info">
                                 <h4 class="control-sidebar-subheading">Editar {{$referencial}}</h4>
                                 <p>Antes de editar un registro debe de completar todo el formulario, si existe algun error encontrara mensajes que lo ayudaran a completar completar con exito el formulario</p>
                               </div>
                             </a>
                           </li>
