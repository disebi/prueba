...
@section('content')
 ...
 <section class="content-header">
          <h1>
            ...
            <a class="btn btn-success" href="{{ action('RoleController@create') }}"><i class="fa fa-plus"></i> Nuevo</a></small>
           </h1>
                  ...
                  <table id="tablalista" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                        {!! Form::open(array('id'=>'formdelete'.$table->id,'method' => 'DELETE', 'route' => array('roles.destroy', $table->id))) !!}

                           <a class="btn btn-default" href="/roles/{{$table->id}}/edit" ><i class="fa fa-edit"></i> </a>
