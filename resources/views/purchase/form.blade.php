                                                 ...
                                                 <div class="col-xs-12">
                                                                <div class="control-group">
                                                                  ...
                                                                  <div class="controls">
                                                                    ...
                                                                    @if(isset($model))
                                                                    {!! Form::hidden('provider_list', $model->provider_id) !!}
                                                                    @endif
                                            ...
                                            <div class="col-xs-11">
                                                <div class="col-xs-4">
                                                  <div class="form-group">
                                                    ...
                                                    {!! Form:: select ("products",[0=>"Seleccionar un Producto"],null,["class"=>"form-control","id"=>"products"])!!}
                                                     </div>
                                                </div>
                                                <div class="col-xs-2">
                                                    <div class="form-group">
...
spin('providerInfo'); spin('spinner');
     ...
     var data={_token:token, id:$("#providers").val()};

     $.ajax({
            url: '{{ action("StockControllers\PurchaseController@getProviderProduct") }}',
            type: 'POST',
            data:data
            })
            .done (function (data2){
            $("#spinner").html("");
               ...
               $('#providerInfo').html('<div class="animsition fade-in"><div class="col-xs-6">' +
                '<p><b>Razon Social: </b> '+data2[1].razon  +'</p>' +
                '<p><b>RUC:</b> '+data2[1].ruc  +'</p>' +
                '<p><b>Empresa:</b> '+data2[1].description  +'</p>' +
                '</div>' +
                '<div class="col-xs-6"></div>' +
                '<p><b>Telefono: </b>'+data2[1].tel  +'</p>' +
                 '<p><b>Direccion: </b>'+data2[1].direcc  +'</p>' +
                 '<p><b>Mail: </b>'+data2[1].mail  +'</p>' +
                   '</div>');
               $.each(data2[0], function(i,item){
                      //introducimos los option del Json obtenido
                      $("#products").append("<option value="+item.id+">"+item.description+"</option>");
               });
                  disable(false);
              });
               }
