...
@section('bread')
  <h1>Compra<small> # {{$model->id}}</small> </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-sm-12 invoice-info">
     <div class="panel panel-success">
        ...
        <div class="col-sm-4 invoice-col">
             ...
             Vendedor
                      <address>
                        <strong>{{$model->salesman->name}} {{$model->salesman->last_name}}</strong><br>
                       {{$model->salesman->position->description}}<br>
                        Sucursal: {{$model->salesman->branch->description}}<br>
                        Tel.   :{{$model->salesman->tel}}<br>
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
