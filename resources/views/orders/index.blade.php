...
@extends('app2')
@include('partials.bread._index',['button'=>action('DistributionControllers\OrderController@search')])
                      ...
                      <tr>
                        ...
                        <td>
                         ...
                         {!! Form::close() !!}
                           ...
                           <a class="btn btn-default" href="/ordenes/{{$order->id}}" ><i class="fa fa-search"></i> </a>
                           <a class="btn btn-default" href="/ordenes/{{$order->id}}/edit" ><i class="fa fa-edit"></i> </a>
