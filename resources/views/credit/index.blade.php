...
@extends('app2')
@include('partials.bread._index',['button'=>action('StockControllers\CreditController@search')])
                  ...
                  <table id="tablalista" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                         {!! Form::open(array('id'=>'formdelete'.$order->id,'method' => 'DELETE', 'route' => array('credito.destroy', $order->id))) !!}
                         {!! Form::close() !!}

                           <a class="btn btn-default" href="/credito/{{$order->id}}" ><i class="fa fa-search"></i> </a>
