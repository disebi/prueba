                                                 ...
                                                 <div class="col-xs-12">
                                                                <div class="control-group">
                                                                  ...
                                                                  <div class="controls">
                                                                   ...
                                                                   <h3>{{$model->client->description}}</h3>
                                                                  {!! Form::hidden('sale_id', $sale) !!}
                                                                ...
                                                                <div id="providerInfo"></div>
                                                                    <div class="col-xs-6">
                                                                <p><b>Razon Social: </b> {{$model->client->razon}}</p>
                                                                                    <p><b>RUC:</b> {{$model->client->ruc}}  </p>
                                                                                    <p><b>Empresa:</b> {{$model->client->description}} </p>
                                                                                    </div>
                                                                                    <div class="col-xs-6"></div>
                                                                                    <p><b>Telefono: </b>{{$model->client->tel}}  </p>
                                                                                     <p><b>Direccion: </b>{{$model->client->direcc}}  </p>
             ...
             <div class="panel-body">
                <div class="form-group">
                                                      ...
                                                      {!!Form::textarea('coment',null,['class'=>'form-control', 'style'=>'resize: none','rows'=>'5']) !!}
                                                       <div class="controls">
                                                       <p>Notas acerca de la Nota de Credito</p>
                                                       </div>
                                                 </div>
             </div>
        </div>
