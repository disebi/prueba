...
class PurchaseController extends Controller {
	...
	{
		$model=Purchase::orderBy('updated_at','desc')->where('state','=',true)->paginate(10);
		$branches=Branch::all();
	...
	public function create()
	{
		...
		return view('purchase.create',compact('lines','providers','user'));
	}
